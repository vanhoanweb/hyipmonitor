...
<div class="listings form large-10 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->input('options', ['options' => $options, 'multiple' => 'checkbox', 'val' => $options_data]);
            ...
            echo $this->Form->input('pay_systems', ['options' => $payments, 'multiple' => 'checkbox', 'val' => $payments_data]);
